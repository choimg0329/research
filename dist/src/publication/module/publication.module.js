...
const publication_controller_1 = require("../controller/publication.controller");
...
exports.PublicationModule = PublicationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [publication_service_1.PublicationService, prisma_service_1.PrismaService],
    })
], PublicationModule);
